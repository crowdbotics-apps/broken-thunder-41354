"""
Django settings for broken_thunder_41354 project.
...
ROOT_URLCONF = 'broken_thunder_41354.urls'
...
WSGI_APPLICATION = 'broken_thunder_41354.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_thunder_41354 API",
    "DESCRIPTION": "API documentation for broken_thunder_41354 App",
    "VERSION": "v1",
}
